...
def add_data_args(parser):
    ...
    parser.add_argument("--advtest_examples", default=-1, type=int,
                        help="The total number of adv test examples to use, where -1 equals all examples.")                            
    ...
    parser.add_argument("--eval_set", choices=['dev', 'test', 'test_adv'], default='dev',
