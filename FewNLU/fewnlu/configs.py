...
class DatasetConfig(BaseConfig):
    def __init__(self, use_cloze:bool, dataset_name:str, task_name:str, data_dir:str, seed:int, train_examples:int,
                 dev_examples:int, dev32_examples:int, unlabeled_examples:int, test_examples:int, advtest_examples: int, eval_set:str, method:str,
        ...
        self.advtest_examples = advtest_examples
